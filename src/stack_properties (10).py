...
print("STACK_PROPERTIES_VERSION = 2026-05-15-v4-clean", flush=True)
...
def main():
    ...
    # Free source dict immediately — don't hold 2 copies
    data.clear()
    del data
    gc.collect()

    log.info("Loaded %d leads, starting stack...", len(leads))
