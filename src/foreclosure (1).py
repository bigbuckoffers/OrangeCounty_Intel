...
def enrich_from_ocpa(auction):
    ...
    try:
        ...
        # Store split fields separately for merger
        if prop_addr:
            auction["prop_street"] = prop_addr.upper()
            auction["prop_city"]   = prop_city
            auction["prop_state"]  = "FL"
            auction["prop_zip"]    = prop_zip
        ...
        if mail_addr:
            ...
            auction["mail_street"] = mail_addr.upper()
            auction["mail_city"]   = mail_city
            auction["mail_state"]  = mail_state
            auction["mail_zip"]    = mail_zip
